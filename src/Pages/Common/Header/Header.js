    ...
    return (
        <div className='sticky z-50 top-0 bg-white flex justify-between items-center shadow-md px-5'>
            ...
            <nav className='text-center text-gray-500 font-semibold hidden md:block'>
                ...
                <Link className='p-3 bar hover:text-black' to="/reviews">Review</Link>
                {
                    !user ?
                        <></>
                        :
            ...
            </nav>
            {
                !user ?
                    ...
                    :
                    <><button className='p-3 hover:text-black md:block hidden' onClick={() => {
                        signOut(auth);
                        navigate('/');
                    }}>LogOut</button></>
            }
            <div className="flex justify-center md:hidden">
                <div>
                    <div className="dropdown relative">
                        ...
                        <ul className=" dropdown-menu min-w-max absolute bg-white text-base z-50 float-left list-none text-left rounded-lg shadow-lg mt-1 hidden m-0 bg-clip-padding border-none"
                            ...
                            </li>
                            {
                                !user ?
                                    ...
                                    <>
                                        <li>
                                            <Link className=" dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100 "
                                                to="/manage-inventories">Manage Item</Link>
                                        </li>
                                        <li>
                                            <Link className=" dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100 "
                                                to="/add-items">Add Item</Link>
                                        </li>
                                        <li>
                                            <Link className=" dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100 "
                                                to="/my-items">My Items</Link>
                                        </li>
                                    </>
                            }
                            <li>
                            ...
                            </li>
                            {
                                !user ?
                                    ...
                                    :
                                    <>
                                        <button className='p-0.5 hover:text-black bg-slate-200 hover:bg-slate-300 border-t-2 w-full' onClick={() => {
                                            signOut(auth);
                                            navigate('/');
                                        }}>LogOut</button>
                                    </>
