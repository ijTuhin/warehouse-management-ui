    ...
    return (
        <div className="flex justify-center">
            <div className="block rounded-lg shadow-lg bg-white text-center m-2 relative">
                <div className='p-2 w-80 h-80 hover:h-96 relative'>
                ...
                <div className='w-full absolute bottom-0 z-20'>
                    <button type="submit" onClick={() => updateItem(_id)} className="w-full py-3 bg-slate-600 text-white font-medium text-xs leading-tight uppercase rounded rounded-t-none shadow-md hover:bg-slate-700 hover:shadow-lg focus:bg-slate-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-slate-800 active:shadow-lg transition duration-150 ease-in-out">Update Item</button>
                </div>
            </div>
        </div>
    );
